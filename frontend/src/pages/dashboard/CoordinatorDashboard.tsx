...
import { AutoDistribution } from '../../components/coordinator/AutoDistribution';
...
export const CoordinatorDashboard: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'manual' as TabType, label: 'Distribuição Manual', icon: Users },
    { id: 'auto' as TabType, label: 'Distribuição Automática', icon: Zap },
    { id: 'management' as TabType, label: 'Gerenciar Avaliações', icon: List },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'manual' && (
          <ManualDistribution onDistributionComplete={handleRefresh} />
        )}

        {activeTab === 'auto' && (
          <AutoDistribution onDistributionComplete={handleRefresh} />
        )}
        ...
        {activeTab === 'management' && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Em breve você poderá gerenciar, editar e remover avaliações existentes.
            </p>
          </div>
        )}
      </div>
